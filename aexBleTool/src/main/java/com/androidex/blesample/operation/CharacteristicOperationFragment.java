package com.androidex.blesample.operation;
...
import com.androidex.blesample.R;
...
public class CharacteristicOperationFragment extends Fragment {
    ...
    public void showData() {
        ...
        final int charaProp = ((OperationActivity) getActivity()).
                getCharaProp();
                                    ...
                                    new BleReadCallback() {
                                            ...
                                            runOnUiThread(new Runnable() {
                                                ...
                                                public void run() {
                                                    if (data.length > 0) {
                                                        ...
                                                        Log.e("liyp_ data =", hexStr);
                                                        addText(txt, hexStr);
                                                        addText(txt, Byte2HexUtil.convertHexToString(hexStr));
                                                    } else {
                                                        addText(txt, "空");
                                                    }
                                                }
                                        ...
                                        public void onReadFailure(final BleException exception) {
                                            runOnUiThread(new Runnable() {
                                                @Override
                                                public void run() {
                                                    Log.e("liyp_ read fail =", exception.toString());
