package com.androidex.fastble.bluetooth;
...
import com.androidex.fastble.BleManager;
...
import com.androidex.fastble.data.BleConnectStateParameter;
import com.androidex.fastble.data.BleDevice;
import com.androidex.fastble.data.BleMsg;
import com.androidex.fastble.exception.ConnectException;
import com.androidex.fastble.exception.OtherException;
import com.androidex.fastble.exception.TimeoutException;
...
public class BleBluetooth {
    ...
    private BluetoothGattCallback coreGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {//操作成功
                if (newState == BluetoothProfile.STATE_CONNECTED) {//连接成功
                    //连接成功时设置MTU
                    //setMTU(60, gatt);//设置无效，Android底层BUG
                    //已连接成功
                } else if (newState == BluetoothProfile.STATE_DISCONNECTED) {//蓝牙主动断开
                    Log.i("liyp_", "蓝牙主动断开");
